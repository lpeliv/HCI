...
export default function NotFound() {
    return (
        <main className="flex items-center justify-center h-screen flex-col text-center bg-blue-200 pt-40 pb-20">
            ...
            <p className="flex flex-col items-center justify-start gap-5 font-roboto whitespace-break-spaces font-bold text-brand-blue-50 text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl p-5" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>
